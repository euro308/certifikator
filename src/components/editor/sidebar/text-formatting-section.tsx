            ...
            <div className="flex gap-1">
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    variant={
                      textElement.align === "left" ? "default" : "outline"
                    }
                    size="icon"
                    className="h-8 w-8"
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    variant={
                      textElement.align === "center" ? "default" : "outline"
                    }
                    size="icon"
                    className="h-8 w-8"
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    variant={
                      textElement.align === "right" ? "default" : "outline"
                    }
                    size="icon"
                    className="h-8 w-8"
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    variant={
                      textElement.align === "justify" ? "default" : "outline"
                    }
                    size="icon"
                    className="h-8 w-8"
