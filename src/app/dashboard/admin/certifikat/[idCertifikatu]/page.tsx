...
import { Calendar, ExternalLink, User, FileText } from "lucide-react";
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      ...
                      className="text-primary flex max-w-[200px] items-center gap-1 truncate text-right hover:underline"
